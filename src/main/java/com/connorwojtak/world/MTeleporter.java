...
import com.connorwojtak.block.BlockMarsPortal;
...
public class MTeleporter extends Teleporter {
    ...
    public boolean makePortal(Entity entityIn)
    {
        ...
        IBlockState iblockstate = MBlocks.MarsPortal.getDefaultState().withProperty(BlockMarsPortal.AXIS, l6 == 0 ? EnumFacing.Axis.Z : EnumFacing.Axis.X);
