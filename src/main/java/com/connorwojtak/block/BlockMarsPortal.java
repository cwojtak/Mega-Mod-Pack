...
public class BlockMarsPortal extends BlockBreakable
{
    ...
    {
        BlockMarsPortal.Size blockportal$size = new BlockMarsPortal.Size(worldIn, pos, EnumFacing.Axis.X);
        ...
        {
            BlockMarsPortal.Size blockportal$size1 = new BlockMarsPortal.Size(worldIn, pos, EnumFacing.Axis.Z);
    ...
    public BlockPattern.PatternHelper createPatternHelper(World worldIn, BlockPos p_181089_2_)
    {
        ...
        BlockMarsPortal.Size blockportal$size = new BlockMarsPortal.Size(worldIn, p_181089_2_, EnumFacing.Axis.X);
        LoadingCache<BlockPos, BlockWorldState> loadingcache = BlockPattern.createLoadingCache(worldIn, true);

        if (!blockportal$size.isValid())
        {
            enumfacing$axis = EnumFacing.Axis.X;
            blockportal$size = new BlockMarsPortal.Size(worldIn, p_181089_2_, EnumFacing.Axis.Z);
        }
    ...
    public static class Size
        {
            ...
            protected int getDistanceUntilEdge(BlockPos p_180120_1_, EnumFacing p_180120_2_)
            {
                ...
                for (i = 0; i < 22; ++i)
                {
                    ...
                    if (!this.isEmptyBlock(this.world.getBlockState(blockpos).getBlock()) || this.world.getBlockState(blockpos.down()).getBlock() != Blocks.DIRT)
                    {
                        break;
                    }
                }
            ...
            protected int calculatePortalHeight()
            {
                ...
                {
                    if (this.world.getBlockState(this.bottomLeft.offset(this.rightDir, j).up(this.height)).getBlock() != Blocks.DIRT)
                    {
                        this.height = 0;
                        break;
                    }
            ...
            public void placePortalBlocks()
            {
                for (int i = 0; i < this.width; ++i)
                {
                    ...
                    {
                        this.world.setBlockState(blockpos.up(j), MBlocks.MarsPortal.getDefaultState().withProperty(BlockMarsPortal.AXIS, this.axis), 2);
                    }
                }
            }
        }
