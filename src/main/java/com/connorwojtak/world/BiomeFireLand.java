...
public class BiomeFireLand extends Biome {

	public BiomeFireLand(BiomeProperties props) {
		super(props);
        ...
        this.spawnableMonsterList.add(new Biome.SpawnListEntry(EntityFireCreeper.class, 100, 4, 4));
