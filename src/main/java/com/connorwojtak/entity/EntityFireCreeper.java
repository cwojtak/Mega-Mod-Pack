...
import com.connorwojtak.entity.ai.EntityFireCreeperAISwell;
...
public class EntityFireCreeper extends EntityMob {
	...
	public void initEntityAI(){
        ...
        this.tasks.addTask(2, new EntityFireCreeperAISwell(this));
    ...
    {
        EntityLiving.registerFixesMob(fixer, EntityFireCreeper.class);
    }
    ...
    private void explode()
    {
        if (!this.worldObj.isRemote)
        {
            ...
            for(i = 0; i <= this.explosionRadius + 2; i++){
            	if(rand.nextBoolean() == true){
            		this.worldObj.setBlockState(new BlockPos(this.posX - this.explosionRadius + i - 1, this.posY, this.posZ + this.explosionRadius + 1), Blocks.FIRE.getDefaultState());
            	}
            }
            for(i = 0; i <= this.explosionRadius + 2; i++){
            	if(rand.nextBoolean() == true){
            ...
            for(i = 0; i <= this.explosionRadius + 2; i++){
            	if(rand.nextBoolean() == true){
            		this.worldObj.setBlockState(new BlockPos(this.posX + this.explosionRadius + 1, this.posY, this.posZ - this.explosionRadius + i - 1), Blocks.FIRE.getDefaultState());
            	}
            }
            for(i = 0; i <= this.explosionRadius + 2; i++){
            	if(rand.nextBoolean() == true){
